...
@Component({
  selector: 'app-pantlist',
  templateUrl: './pantlist.component.html',
  styleUrls: ['./pantlist.component.css']
})
export class PantlistComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.shopList=this.productService. getpantsproducts();
    this.loadWishList();
    this.resetForm();
