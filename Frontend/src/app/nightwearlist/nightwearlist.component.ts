...
@Component({
  selector: 'app-nightwearlist',
  templateUrl: './nightwearlist.component.html',
  styleUrls: ['./nightwearlist.component.css']
})
export class NightwearlistComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.shopList=this.productService.getnightwearproducts();
    this.loadWishList();
    this.resetForm();
  }
